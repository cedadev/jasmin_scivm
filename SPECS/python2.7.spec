# not sure what's happening here - Alan commented out these lines and added it as global
# (see third line) to force main_python = 0
...
# # Alan added this for moving stuff that ends up in the wrong place...
# #  Now fixed(?) - include lib64 patch
# %global pylibdir32 /usr/lib/python%{pybasever}
# %global site_packages32 %{pylibdir32}/site-packages
...
Patch103: Python-2.7.3-lib64.patch
# 
# # SELinux patches
...
ln -s python $topdir/python%{pybasever}
...
# Alan put a condition around this - seems to happen automatically?
if [ -e $RPM_BUILD_ROOT/%{_mandir}/man1/%{python}.1 ]
then
...
# # move stuff ending up in /usr/lib rather than /usr/lib64 - Alan
# if [ %{pylibdir} != %{pylibdir32} ]
# then
#    pushd $RPM_BUILD_ROOT%{pylibdir32}
#    for i in *
#    do
#      if [ $i != site-packages ]
#      then
#         mv $i $RPM_BUILD_ROOT%{pylibdir}/
#      fi
#    done
#    popd
# fi
...
- put in 2.7 sources and remove all patches
