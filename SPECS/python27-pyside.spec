...
Patch1: pyside-include-path.patch
License: LGPL
...
%build
export QT_PHONON_INCLUDE_DIR=/usr/include/phonon
env CFLAGS="$RPM_OPT_FLAGS" python2.7 setup.py build --qmake=%{qmake_path}

%install
rm -fr $RPM_BUILD_ROOT
export QT_PHONON_INCLUDE_DIR=/usr/include/phonon
python2.7 setup.py install -O1 --root=$RPM_BUILD_ROOT --record=INSTALLED_FILES1 --qmake=%{qmake_path}
