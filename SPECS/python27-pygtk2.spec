...
%define pango_version		1.28.1
%define gtk2_version		2.20.1
%define libglade2_version	2.6.4
%define pycairo_version		1.8.6
%define pygobject2_version	2.20.0
...
Requires: python27-pycairo
Requires: python27-pygobject2
...
BuildRequires: python27-pycairo >= %{pycairo_version}
BuildRequires: pygobject2-devel >= %{pygobject2_version}
BuildRequires: python27-pygobject2 >= %{pygobject2_version}
...
%package demos
Summary: Demos for pygtk2
Group: Development/Languages
Requires: %{name} = %{version}-%{release}

%description demos
This package contains demos for pygtk2.  Duplicates (and conflicts
with) part of the standard pygtk2 package, so in the context of the
CEDA python2.7 build has been moved to an optional subpackage.
