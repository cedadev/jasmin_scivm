...
Requires: eccodes-devel >= 2.4.1-1.ceda
Requires: eccodes-fortran >= 2.4.1-1.ceda
Requires: eccodes >= 2.4.1-1.ceda
Requires: eccodes-python27 >= 2.4.1-1.ceda
Requires: emacs >= 23.1
...
Requires: grads >= 2.1.1.b0-1.ceda
...
Requires: nccmp >= 1.8.2.1-1.ceda
Requires: ncl >= 6.4.0-1.ceda
Requires: nco >= 4.7.3-1.ceda
Requires: nco-devel >= 4.7.3-1.ceda
Requires: ncview >= 2.1.7-1.ceda
Requires: nedit >= 5.5
Requires: netcdf >= 4.4.1-1.ceda
Requires: netcdf-c++ >= 4.2-6.ceda
Requires: netcdf-c++-devel >= 4.2-6.ceda
Requires: netcdf-devel >= 4.4.1-1.ceda
Requires: netcdf-fortran >= 4.4.3-3.ceda
Requires: netcdf-fortran-devel >= 4.4.3-3.ceda
Requires: octave >= 4.0.0-3.ceda
Requires: octave-devel >= 4.0.0-3.ceda
Requires: octave-doc >= 4.0.0-3.ceda
...
Requires: python27-Cython >= 0.28.1-1.ceda
...
Requires: python27-Sphinx >= 1.7.6-1.ceda
Requires: python27-Theano >= 1.0.1-1.ceda
...
Requires: python27-ccplot >= 1.5.2-1.ceda
Requires: python27-cdat_lite >= 6.0rc2-7.ceda
Requires: python27-cerbere >= 0.1.619-1.ceda
Requires: python27-cf >= 2.2.4-1.ceda
Requires: python27-cf-checker >= 3.0.5-1.ceda
Requires: python27-cf-plot >= 2.1.75-1.ceda
Requires: python27-cf-units >= 2.0.2-1.ceda
Requires: python27-cf-view >= 1.0.4-1.ceda
Requires: python27-cftime >= 1.0.0-1.ceda
Requires: python27-cis >= 1.5.4-1.ceda
Requires: python27-cloudpickle >= 0.2.1-1.ceda
Requires: python27-cmor >= 3.3.2-1.ceda
Requires: python27-cycler >= 0.10.0-1.ceda
Requires: python27-dask >= 0.17.2-1.ceda
Requires: python27-descartes >= 1.1.0-1.ceda
Requires: python27-ecmwf-api-client >= 1.4.2-1.ceda
Requires: python27-emcee >= 2.2.1-1.ceda
Requires: python27-enum34 >= 1.0.4-1.ceda
Requires: python27-eofs >= 1.2.0-1.ceda
Requires: python27-esgf-pyclient >= 0.1.8-1.ceda
Requires: python27-filelock >= 3.0.4-1.ceda
Requires: python27-geopandas >= 0.3.0-1.ceda
...
Requires: python27-joblib >= 0.11-1.ceda
...
Requires: python27-numpy >= 1.14.5-1.ceda
Requires: python27-packaging >= 17.1-1.ceda
Requires: python27-pandas >= 0.19.1-1.ceda
Requires: python27-partd >= 0.3.8-1.ceda
Requires: python27-patsy >= 0.5.0-1.ceda
Requires: python27-pep8 >= 1.7.1-1.ceda
Requires: python27-psycopg2 >= 2.6.2-1.ceda
Requires: python27-pybtex >= 0.21-1.ceda
Requires: python27-pycairo >= 1.8.6-1.ceda
Requires: python27-pycodestyle >= 2.3.1-1.ceda
...
Requires: python27-pymc3 >= 3.3-1.ceda
Requires: python27-pyproj >= 1.9.5.1-1.ceda
Requires: python27-pyshp >= 1.2.10-1.ceda
Requires: python27-pyspharm >= 1.0.8-1.ceda
Requires: python27-pystan >= 2.17.1.0-1.ceda
Requires: python27-pyugrid >= 0.3.1-1.ceda
Requires: python27-pyzmq >= 2.2.0.1-3.ceda
Requires: python27-requests >= 2.18.1-1.ceda
Requires: python27-rpy2 >= 2.3.9-1.ceda
Requires: python27-s3transfer >= 0.1.13-1.ceda
Requires: python27-scikit-image >= 0.13.0-1.ceda
Requires: python27-scikit-learn >= 0.19.1-1.ceda
Requires: python27-scipy >= 0.19.1-1.ceda
Requires: python27-scitools-iris >= 2.1.0-2.ceda
Requires: python27-seaborn >= 0.7.1-1.ceda
Requires: python27-setuptools >= 39.0.1-1.ceda
Requires: python27-six >= 1.11.0-1.ceda
Requires: python27-statsmodels >= 0.8.0-1.ceda
Requires: python27-sympy >= 1.2-1.ceda
Requires: python27-toolz >= 0.9.0-1.ceda
Requires: python27-tornado >= 3.2-1.ceda
Requires: python27-tqdm >= 4.19.9-1.ceda
...
Requires: umutil-lib >= 20130102-3.ceda
Requires: uuid >= 1.6.1
...
- R-ncdf4 >= 1.16-1.ceda
- cdo >= 1.9.3-1.ceda
- cmip6-cmor-tables >= 6.1.23-1.ceda
- cmor-libs >= 3.3.2-1.ceda
- grads >= 2.1.1.b0-1.ceda
- nco >= 4.7.3-1.ceda
- nco-devel >= 4.7.3-1.ceda
- python27-Cython >= 0.28.1-1.ceda
- python27-Fiona >= 1.7.11.post1-1.ceda
- python27-ImageHash >= 4.0-1.ceda
- python27-PyYAML >= 3.12-1.ceda
- python27-Pygments >= 2.2.0-2.ceda
- python27-Sphinx >= 1.7.6-1.ceda
- python27-Theano >= 1.0.1-1.ceda
- python27-backports-common >= 1.1-1.ceda
- python27-backports-functools_lru_cache >= 1.5-1.ceda
- python27-backports-ssl_match_hostname >= 3.4.0.2-3.ceda
- python27-boto3 >= 1.6.21-1.ceda
- python27-botocore >= 1.9.21-1.ceda
- python27-ccplot >= 1.5.2-1.ceda
- python27-cerbere >= 0.1.619-1.ceda
- python27-cf >= 2.2.4-1.ceda
- python27-cf-plot >= 2.1.75-1.ceda
- python27-cf-units >= 2.0.2-1.ceda
- python27-cftime >= 1.0.0-1.ceda
- python27-cloudpickle >= 0.2.1-1.ceda
- python27-cmor >= 3.3.2-1.ceda
- python27-dask >= 0.17.2-1.ceda
- python27-descartes >= 1.1.0-1.ceda
- python27-emcee >= 2.2.1-1.ceda
- python27-enum34 >= 1.0.4-1.ceda
- python27-filelock >= 3.0.4-1.ceda
- python27-geopandas >= 0.3.0-1.ceda
- python27-ilamb >= 2.3-1.ceda
- python27-iris >= 2.0.0-1.ceda
- python27-iris-grib >= 0.13.0-1.ceda
- python27-jmespath >= 0.9.3-1.ceda
- python27-joblib >= 0.11-1.ceda
- python27-kiwisolver >= 1.0.1-1.ceda
- python27-latexcodec >= 1.0.5-1.ceda
- python27-locket >= 0.2.0-1.ceda
- python27-matplotlib >= 2.2.2-2.ceda
- python27-mpmath >= 1.0.0-1.ceda
- python27-numpy >= 1.14.5-1.ceda
- python27-packaging >= 17.1-1.ceda
- python27-partd >= 0.3.8-1.ceda
- python27-patsy >= 0.5.0-1.ceda
- python27-pep8 >= 1.7.1-1.ceda
- python27-pybtex >= 0.21-1.ceda
- python27-pycairo >= 1.8.6-1.ceda
- python27-pycodestyle >= 2.3.1-1.ceda
- python27-pymc3 >= 3.3-1.ceda
- python27-pystan >= 2.17.1.0-1.ceda
- python27-pyugrid >= 0.3.1-1.ceda
- python27-s3transfer >= 0.1.13-1.ceda
- python27-scikit-learn >= 0.19.1-1.ceda
- python27-scitools-iris >= 2.1.0-2.ceda
- python27-setuptools >= 39.0.1-1.ceda
- python27-six >= 1.11.0-1.ceda
- python27-statsmodels >= 0.8.0-1.ceda
- python27-sympy >= 1.2-1.ceda
- python27-toolz >= 0.9.0-1.ceda
- python27-tqdm >= 4.19.9-1.ceda
- python27-xarray >= 0.10.2-1.ceda

Also in top-level RPMs bump mpi4py (1.3 -> 1.3.1):
  python27-mpi4py-mpich >= 1.3.1-1.ceda
  python27-mpi4py-platform_mpi >= 1.3.1-1
