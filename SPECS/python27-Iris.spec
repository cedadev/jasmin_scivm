...
Requires: python27, python27-pyke, python27-Cython, python27-cartopy, python27-Shapely, python27-shapefile
BuildRequires: python27, python27-pyke, python27-Cython, python27-cartopy, python27-Shapely, python27-shapefile
